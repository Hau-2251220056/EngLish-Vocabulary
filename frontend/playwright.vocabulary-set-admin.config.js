...
export default defineConfig({
  ...
  testMatch: "vocabulary-set-admin-real-stack.spec.js",
  fullyParallel: false,
  workers: 1,
  ...
  reporter: "list",
  outputDir: "test-results/vocabulary-set-admin",
  ...
  projects: [{ name: "chromium-vocabulary-set-admin", use: { ...devices["Desktop Chrome"] } }],
  webServer: [
    {

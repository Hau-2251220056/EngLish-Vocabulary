...
1. Nghe phát âm mẫu.
2. Tự phát âm từ.
3. Hệ thống có thể phân tích và đánh giá mức độ phù hợp của phát âm.
4. Hiển thị feedback phù hợp cho người dùng.
...
* Phân quyền USER/ADMIN theo nghiệp vụ được cho phép.
...
5. Dễ kiểm thử.
6. Dễ bảo trì.
7. Chỉ mở rộng khi thực sự cần thiết.
...
Khi có sự khác biệt giữa các tài liệu, AI Agent ưu tiên theo thứ tự:
...
Nếu các tài liệu có mâu thuẫn về nghiệp vụ, AI Agent phải dừng việc tự quyết định và yêu cầu người phát triển xác nhận.
...
phải được cập nhật vào tài liệu trước hoặc đồng thời với việc triển khai để đảm bảo tài liệu và source code luôn nhất quán.
